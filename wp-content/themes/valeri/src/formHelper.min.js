...
window.leadvertex || (window.leadvertex = {}), window.leadvertex.selling || (window.leadvertex.selling = {}), window.leadvertex.selling.delivery || (window.leadvertex.selling.delivery = {}), window.leadvertex.selling.discount || (window.leadvertex.selling.discount = {}), window.leadvertex.selling.price || (window.leadvertex.selling.price = {}), window.leadvertex.selling.quantity || (window.leadvertex.selling.quantity = 0), window.leadvertex.selling.additional || (window.leadvertex.selling.additional = {}), window.leadvertex.selling.additionalSum || (window.leadvertex.selling.additionalSum = 0), window.leadvertex.goods || (window.leadvertex.goods = {}), window.leadvertex.goods.added || (window.leadvertex.goods.added = {}), window.leadvertex.form = {}, window.leadvertex.form.label = function (e, a, t) {
    ...
    a ? 2 > a && (a = "") : a = "", "update" == a && (a = "-update"), lvjq1(document).ready(function () {
        var t = lvjq1("#lv-form" + a);
        t.find(".lv-row").each(function (a, t) {
            var d = lvjq1(t).attr("data-name"), l = -1 == lvjq1.inArray(d, e), o = lvjq1(t).attr("data-required");
    ...
    if ("undefined" == typeof window.leadvertex.goodsPrices) return !0;
    var d = ".lv-input-goods";
    "update" == e ? (e = "Update", d = "#lv-formLandingUpdate-goods") : (e = parseInt(e), e > 0 && (d = "#lv-formLanding" + e + "-goods"));
    var l = 0;
    if (window.leadvertex.goodsPrices.hasOwnProperty(a)) {
        var o = window.leadvertex.goodsPrices[a], r = o.maxQuantity, n = o.prices;
        if (n[t]) l = n[t]; else {
            var v = 0, i = 0;
    ...
    lvjq1(".lv-good-price-total").each(function (a, t) {
        ...
        if ("update" == d && (d = "Update"), d == e) {
            console.log(e);
            var l = "#lv-formLanding" + e + "-goods", o = 0, r = JSON.parse(lvjq1(l).val());
    ...
    function e() {
        ...
        for (var e in window.leadvertex.selling.additional) window.leadvertex.selling.additionalSum += parseInt(window.leadvertex.selling.additional[e]);
        return parseInt(window.leadvertex.selling.additionalSum)
    }

    function a() {
        var a = lvjq1(".lv-input-quantity"), t = window.leadvertex.selling.quantity;
        a.length > 0 && (t = parseInt(a.val()));
        var d, l = window.leadvertex.selling.delivery, o = window.leadvertex.selling.discount, r = parseInt(l.price);
        l.for_Each ? (d = r * t, lvjq1(".lv-delivery-price").text(d)) : d = r;
        var n = parseInt(window.leadvertex.selling.price.price) + e(), v = 0, i = !0, s = 0;
        if (o[t]) v = o[t].discount, i = o[t].round, s = o[t].sum; else {
            var w = -1;
            for (var u in o) {
                if (!(t >= u)) break;
                w = u
        ...
        n = f, i && (n = Math.round(n)), lvjq1(".lv-quantity-discount-sum").text(parseInt(c)), lvjq1(".lv-quantity-discount-percent").text(parseInt(v)), lvjq1(".lv-total-price").each(function (e, a) {
            var t = $(a), l = parseInt(d) + parseInt(n), o = parseInt(t.attr("data-sum")), r = t.attr("data-operation"),
    ...
    function t(e, a, t, d, l, o) {
        window.leadvertex.goods.added = "" != lvjq1(d).val() ? JSON.parse(lvjq1(d).val()) : {}, window.leadvertex.goods.added[e] = {
            quantity: a,
            sum: t
        }, lvjq1(d).val(JSON.stringify(window.leadvertex.goods.added)), 1 == o && (l = ".lv2-form" + l, console.log(l), lvjq1(l).submit()), r(l)
    }

    function d(e, a, t) {
        window.leadvertex.goods.added = "" != lvjq1(a).val() ? JSON.parse(lvjq1(a).val()) : {}, window.leadvertex.goods.added[e] && delete window.leadvertex.goods.added[e], lvjq1(a).val(JSON.stringify(window.leadvertex.goods.added)), r(t)
    }
    ...
    function l(e, a) {
        ...
        t.form = a, t.alias = e, lvjq1.ajax({
            url: "/order/addOrderGoods", type: "post", data: t, success: function (e) {
    ...
    lvjq1(".lv-move").each(function (e, a) {
        ...
        var e = lvjq1(this).attr("data-lv-alias"), a = lvjq1(this).attr("data-lv-add-text"),
            r = lvjq1(this).attr("data-lv-remove-text"), n = lvjq1(this).attr("data-lv-add-class"),
            v = lvjq1(this).attr("data-lv-remove-class"), i = lvjq1(this).attr("data-lv-add-remove"),
            s = lvjq1(this).attr("data-lv-price"), w = lvjq1(this).attr("data-lv-submit"),
            u = lvjq1(this).attr("data-lv-ajax"), f = ".lv-input-goods", c = lvjq1(this).attr("data-lv-form");
        switch ("update" == c ? (c = "Update", f = "#lv-formLandingUpdate-goods") : (c = parseInt(c), c > 0 && (f = "#lv-formLanding" + c + "-goods")), i) {
            case"add":
                lvjq1(this).text(r), lvjq1(this).attr("data-lv-add-remove", "remove"), lvjq1(this).removeClass(n), lvjq1(this).addClass(v), u ? l(e, c) : t(e, 1, s, f, c, w);
                break;
            case"remove":
                lvjq1(this).text(a), lvjq1(this).attr("data-lv-add-remove", "add"), lvjq1(this).removeClass(v), lvjq1(this).addClass(n), u ? o(e, c) : d(e, f, c)
        }
    }), lvjq1(".lv-good-quantity").change(function () {
        var e = lvjq1(this).attr("data-lv-alias"), a = JSON.parse(lvjq1(this).attr("data-lv-prices")),
            l = parseInt(lvjq1(this).attr("data-lv-max-quantity")), o = parseInt(lvjq1(this).val()),
            r = ".lv-input-goods", n = lvjq1(this).attr("data-lv-form");
        if ("update" == n ? (n = "Update", r = "#lv-formLandingUpdate-goods") : (n = parseInt(n), n > 0 && (r = "#lv-formLanding" + n + "-goods")), o > 0) if (a[o]) t(e, o, a[o], r, n); else {
            var v = 0, i = 0;
            for (var s in a) a.hasOwnProperty(s) && (v = l > o && o > i ? i : l, i = s);
            var w = parseInt(a[v] / v * o);
            t(e, o, w, r, n)
        } else d(e, r, n)
    }), lvjq1(".lv-good-select").change(function () {
        var e = JSON.parse(lvjq1(this).attr("data-lv-prices")), a = lvjq1(this).val(), l = ".lv-input-goods",
            o = lvjq1(this).attr("data-lv-form");
        if ("update" == o ? (o = "Update", l = "#lv-formLandingUpdate-goods") : (o = parseInt(o), o > 0 && (l = "#lv-formLanding" + o + "-goods")), 0 != a) {
            if (e[a]) {
                for (var r in e) e.hasOwnProperty(r) && r != a && d(r, l, o);
                t(a, 1, e[a], l, o)
            }
        } else for (var n in e) e.hasOwnProperty(n) && d(n, l, o)
    })
});
